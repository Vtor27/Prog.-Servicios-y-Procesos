...
public class Ejercicio7 {
	...
	//7.	Crear otra ampliación del programa 2 para que redirija la salida de la ejecución 
	//		del programa 1 a su flujo de ejecución y lo escriba en un fichero (pista: utilizar redirectOutput).
