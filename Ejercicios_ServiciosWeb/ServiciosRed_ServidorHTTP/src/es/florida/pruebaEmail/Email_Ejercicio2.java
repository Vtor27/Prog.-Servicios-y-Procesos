...
//		}
	...
	public static void main(String[] args) {
		...
		String[] emailDestino = {"vigode@alumnatflorida.es", "vtorgonza27@gmail.com"};
		...
		try {
			for (int i = 0; i < emailDestino.length; i++) {
				envioMail(strMensaje, strAsunto,emailRemitente ,emailRemitentePass , hostEmail, portEmail, emailDestino[i], anexo);
				System.out.println("Mensaje enviado a " + emailDestino[i] + "....");
